    ...
    const BackToTopButton = () => {
      ...
      return (
        <button
          ...
          className="rar-back-to-top-button rar-back-to-top-floating"
            ...
            <div>
              ...
              <div className="rar-view-mode-container">
                ...
                <div className="rar-view-mode-options">
                  <label className="rar-view-mode-label">
                    <input
                      type="radio"
                      value="Basic"
                        ...
                        <tr title="Risk assessment framework used for assessing this risk"> 
                          ...
                          <td className="rar-form-input-cell">
                            ...
                            >
                              ...
                              <option value="custom">
                                Custom/Organisational Framework
                              </option>
              ...
              <fieldset id="risk-assessment-section" className="rar-fieldset rar-fieldset-assessment">
                ...
                <table className="rar-form-table">
                  <tbody>
                              ...
                              <td className="rar-form-input-cell">
                                <div className="rar-current-risk-reference">
                                  ...
                                  <small className="rar-help-text" style={{ marginLeft: '12px' }}>
                                    From Inherent Risk tab for comparison
                                  </small>
                                </div>
                              </td>
                            </tr>
                              ...
                              {form.lossDistribution && (
                                <small className="rar-help-text rar-distribution-info">
                                  ...
                                  {form.lossDistribution === "triangular" && 
                                    <>Commonly used when you have minimum, most likely, and maximum loss estimates. Ideal for expert judgment scenarios where three-point estimates are available. <a href="https://en.wikipedia.org/wiki/Triangular_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.lossDistribution === "pert" && 
                                    <>Modified PERT (Program Evaluation and Review Technique) provides more refined estimates than triangular. Uses minimum, most likely, maximum values, and a gamma parameter (γ) controlling the weight given to the most likely value. Standard PERT uses γ=4. Higher gamma values increase mode emphasis. Particularly useful for project risk analysis and expert estimation scenarios. <a href="https://en.wikipedia.org/wiki/PERT_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.lossDistribution === "normal" && 
                                    <>Used for losses that cluster around a mean value with symmetric spread. Suitable for well-understood risks with historical data showing bell-curve patterns. <a href="https://en.wikipedia.org/wiki/Normal_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  ...
                                  {form.lossDistribution === "gamma" && 
                                    <>Right-skewed distribution ideal for modeling positive losses with lower bound. Uses shape (α) and scale (β) parameters. Common for financial losses, claim amounts, and time-to-event data. Shape parameter controls skewness: α&lt;1 highly right-skewed, α&gt;1 less skewed. <a href="https://en.wikipedia.org/wiki/Gamma_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.lossDistribution === "pareto" && 
                                    <>Heavy-tailed distribution following the 80/20 principle - most losses are small, but extreme losses have significant probability. Uses minimum value (xₘ) and shape parameter (α). Ideal for modeling catastrophic losses, cyber incidents, and operational risk scenarios. <a href="https://en.wikipedia.org/wiki/Pareto_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.lossDistribution === "weibull" && 
                                    <>Versatile distribution for modeling failure rates and reliability. Uses shape (k) and scale (λ) parameters. Shape parameter controls distribution behavior: k&lt;1 decreasing failure rate, k=1 constant (exponential), k&gt;1 increasing failure rate. Common for equipment failures and life data analysis. <a href="https://en.wikipedia.org/wiki/Weibull_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                </small>
                              )}
                            </td>
                          </tr>
                              ...
                              {form.frequencyDistribution && (
                                <small className="rar-help-text rar-distribution-info">
                                  ...
                                  {form.frequencyDistribution === "triangular" && 
                                    <>Used when you can estimate minimum, most likely, and maximum frequencies based on expert judgment or limited historical data. <a href="https://en.wikipedia.org/wiki/Triangular_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.frequencyDistribution === "pert" && 
                                    <>Enhanced version of triangular distribution with gamma parameter for better shape control. Provides more realistic modeling of frequency estimates with adjustable confidence in the mode value. <a href="https://en.wikipedia.org/wiki/PERT_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.frequencyDistribution === "poisson" && 
                                    <>Ideal for modeling discrete event counts (e.g., number of incidents per year) when events occur independently at a constant average rate. <a href="https://en.wikipedia.org/wiki/Poisson_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  ...
                                  {form.frequencyDistribution === "negative-binomial" && 
                                    <>Models the number of failures before achieving a specified number of successes. Ideal for overdispersed count data where variance exceeds the mean. Common in reliability testing and quality control scenarios. <a href="https://en.wikipedia.org/wiki/Negative_binomial_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {form.frequencyDistribution === "binomial" && 
                                    <>Models the number of successes in a fixed number of independent trials. Perfect for scenarios with a known number of opportunities and constant success probability (e.g., number of successful attacks out of total attempts). <a href="https://en.wikipedia.org/wiki/Binomial_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                          ...
                          <tr title="Current risk level from the main Risk tab for reference comparison" className="rar-tab-specific-content">
                            ...
                            <td className="rar-form-input-cell">
                              <div className="rar-current-risk-reference">
                                ...
                                <small className="rar-help-text" style={{ marginLeft: '12px' }}>
                                  From Inherent Risk tab - Expected Annual Loss: {calculateMonteCarloExpectedLoss(form)}
                                </small>
                              </div>
                            </td>
                          </tr>
                            ...
                            <td className="rar-form-input-cell">
                              ...
                              <small className="rar-help-text">
                                ...
                                {(form.residualLossDistribution || form.lossDistribution) === "triangular" && 
                                  <>Three-point estimates for post-control residual losses. <a href="https://en.wikipedia.org/wiki/Triangular_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "pert" && 
                                  <>Program Evaluation and Review Technique with gamma parameter controlling weighted emphasis on most likely outcome for residual losses after controls. <a href="https://en.wikipedia.org/wiki/PERT_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "normal" && 
                                  <>Bell-curve pattern for residual losses after controls. <a href="https://en.wikipedia.org/wiki/Normal_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "lognormal" && 
                                  <>Right-skewed residual losses using natural logarithm (ln, base e). Parameters: μ = 1-6, σ = 0.3-1.2. Fields represent underlying normal distribution parameters. <a href="https://en.wikipedia.org/wiki/Log-normal_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "uniform" && 
                                  <>Equally likely residual loss values within range. <a href="https://en.wikipedia.org/wiki/Continuous_uniform_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "beta" && 
                                  <>Flexible bounded residual loss distribution. <a href="https://en.wikipedia.org/wiki/Beta_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "gamma" && 
                                  <>Right-skewed residual losses with shape and scale parameters. Ideal for positive post-control losses with lower bound. <a href="https://en.wikipedia.org/wiki/Gamma_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "pareto" && 
                                  <>Heavy-tailed residual losses following 80/20 principle. Most residual losses small, but extreme losses have significant probability. <a href="https://en.wikipedia.org/wiki/Pareto_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                {(form.residualLossDistribution || form.lossDistribution) === "weibull" && 
                                  <>Versatile residual loss distribution for reliability modeling. Shape parameter controls failure rate behavior. <a href="https://en.wikipedia.org/wiki/Weibull_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                              ...
                              {(form.residualFrequencyDistribution || form.frequencyDistribution) && (
                                <small className="rar-help-text rar-distribution-info">
                                  ...
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "triangular" && 
                                    <>Used when you can estimate minimum, most likely, and maximum residual frequencies based on expert judgment or limited historical data. <a href="https://en.wikipedia.org/wiki/Triangular_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "pert" && 
                                    <>Enhanced version of triangular distribution with gamma parameter for better shape control. Provides more realistic modeling of residual frequency estimates with adjustable confidence in the mode value. <a href="https://en.wikipedia.org/wiki/PERT_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "poisson" && 
                                    <>Ideal for modeling discrete residual event counts (e.g., number of incidents per year) when events occur independently at a constant average rate. <a href="https://en.wikipedia.org/wiki/Poisson_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  ...
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "negative-binomial" && 
                                    <>Models the number of trials needed to achieve a fixed number of successes after implementing controls. Useful for quality control and reliability testing with overdispersion. <a href="https://en.wikipedia.org/wiki/Negative_binomial_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "binomial" && 
                                    <>Models the number of successes in a fixed number of independent trials with known success probability. Ideal for pass/fail scenarios and compliance testing. <a href="https://en.wikipedia.org/wiki/Binomial_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "geometric" && 
                                    <>Models the number of trials until the first success. Perfect for time-to-first-failure analysis and breakthrough event modeling. <a href="https://en.wikipedia.org/wiki/Geometric_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {(form.residualFrequencyDistribution || form.frequencyDistribution) === "discrete-uniform" && 
                                    <>Each outcome within a discrete range is equally likely. Used when any integer value between bounds has equal probability of occurrence. <a href="https://en.wikipedia.org/wiki/Discrete_uniform_distribution" target="_blank" rel="noopener noreferrer" style={{ color: '#0099cc', textDecoration: 'underline' }}>Learn more</a></>}
                                  {!form.residualFrequencyDistribution && form.frequencyDistribution && (
                                    <>
                                      <br />
                    ...
                    {form.assessmentType === 'advancedQuantitative' && activeAdvancedQuantitativeTab === 'heatmap' && (
                        ...
                        <tr className="rar-tab-specific-content">
                          <td colSpan="2">
                            <div style={{
                              ...
                              <div style={{ marginBottom: '12px' }}>
                                <strong>Heat Map Technical Details:</strong> Each heat map shows the joint probability distribution of frequency and unit cost combinations. Colour intensity represents the probability of occurrence for each frequency-cost combination, with darker red areas indicating higher probability regions as generated by Monte Carlo simulations. These probability densities will vary from one Monte Carlo simulation run to another. Contour lines represent percentiles of total loss (frequency × unit cost). Hover over cells to see exact probability values and sample counts.
                              </div>
                              <div style={{ marginBottom: '12px' }}>
                              ...
                              <div style={{ marginBottom: '8px' }}>
                                <strong>Interpretation:</strong> Darker areas indicate higher probability of occurrence. The spread and intensity patterns help visualise risk concentration and the effectiveness of implemented controls.
                              </div>
                            </div>
                          </td>
                        </tr>
